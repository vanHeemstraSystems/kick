            ...
            this.subscriptions.forEach( function (subscription) {
                ...
                for (key in subscription) {
                    ...
                    if(key == 'channel') {
                        ...
                        console.log('CORE: viewServiceBase channel:');
                        console.log(channel);
                    }
                    // One channel has one or more topics
                    if(key == 'topic') {
                        var topic = subscription[key];
                        console.log('CORE: viewServiceBase topic:');
                        console.log(topic);
                        topicArray.push(topic);
                    }                    
                }
                console.log('CORE: viewServiceBase topicArray:');
                ...
                for(topic in topicArray) {
                    ...
                    var callback = function(data, envelope){
                        // empty for now
                        console.log('CORE: viewServiceBase data received:');
                        console.log(data);
                        console.log('CORE: viewServiceBase envelope received:');
